...
public class FirebaseUser: ObservableObject, FirestoreObservable {
    ...
    public func signUp<Human: Person>(newPerson: @escaping (_ uid: PersonID, _ email: String, _ nickname: String) -> Human = Human.new, complete: ((_ person: Human?, _ error: Error?) -> ())? = nil) {
        guard nickname != "" else {
